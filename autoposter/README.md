...
A GitHub Actions workflow runs the full pipeline automatically on the **1st of each month at 9am UTC**, opening a draft PR with the generated post.
...
- The workflow installs autoposter, runs the full pipeline, and opens a draft PR authored by `github-actions[bot]`
- Logs are uploaded as workflow artifacts for debugging
